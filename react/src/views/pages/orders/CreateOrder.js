  ...
  return (
    ...
    <div style={{ border:"3px solid #00A064",  boxShadow: 'rgba(0, 0, 0, 0.4) 0px 4px 12px' ,borderRadius:"7px"}}>
      <div style={{ display: "flex", justifyContent: "space-around" , paddingTop:"50px"}}>
        <div>
          <span><b>Electro Service</b></span><br />
          <span>Mobile:01518389862</span><br />
          <span>Email:electro@gmail.com</span><br />
          <span>Address:Mirpur</span><br />
        </div>
      ...
      <Table striped bordered hover size="sm" >
        <thead style={{ backgroundColor: "#00A064", textAlign: "center",color:"white"}}>
          <tr>
      ...
      <div style={{ display: "flex", width: "100%", padding: "20px" }}>
        ...
        <div style={{marginTop: "100px",  marginLeft: "60%", float: "right" }} >
          <Button onClick={handleSubmit} variant="warning" style={{ width: "150px", height: "40px" ,backgroundColor:"#00A064" ,color:"white"}} active>Submit</Button>{' '}
        </div>
      </div>
      </div>
    </>
